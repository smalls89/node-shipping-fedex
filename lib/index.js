...
function FedEx(args) {
  ...
  var resources = {
    rates: {f: buildRatesRequest, r: handleRatesResponse, wsdl: 'RateService_v16.wsdl', path: '/web-services'},
    ship: {f: buildShipRequest, r: handleShipResponse, wsdl: 'ValidationAvailabilityAndCommitmentService_v2.wsdl', path: '/web-services'},
    track: {f: buildTrackingRequest, r: handleTrackingResponse, wsdl: 'TrackService_v9.wsdl', path: '/web-services'},
    freight_rates: {f: buildFreightRatesRequest, r: handleFreightRatesResponse, wsdl: 'RateService_v16.wsdl', path: '/web-services'}
  };
